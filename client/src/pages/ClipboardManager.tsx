...
export default function ClipboardManager() {
  ...
  return <div className="features-page feature-detail-page">
    ...
    <section className="section privacy-section"><div className="shell privacy-layout official-privacy-layout"><div className="privacy-copy"><p className="eyebrow">Android and privacy boundaries</p><h2>Saved content stays local to your device.</h2><p>Android system restrictions can affect clipboard access in the background. Mr. Copy does not claim to capture every clipboard event in every Android state, and it does not synchronize saved clips to a cloud clipboard.</p><p className="muted-note">The Floating Bubble is the quick-access companion for Recent and Starred content when you are working in another Android app.</p><Link href="/features/floating-bubble" className="text-link">Learn how the Floating Bubble helps you copy saved content again <Copy size={16} aria-hidden="true" /></Link><Link href="/help/android-clipboard-access" className="text-link">Understand Android clipboard-access limitations</Link><Link href="/privacy" className="text-link">Read how local saved data is handled</Link></div><div className="privacy-asset-panel"><span>Local clipboard library</span><small>Account identity and entitlement records are separate from saved clips.</small></div></div></section>
  </div>;
}
