...
const benefits = [
  ...
  { icon: Sparkles, title: "Open quick access", body: "Use the Floating Bubble to open Recent and Starred items over another Android app after you enable its overlay permission." },
